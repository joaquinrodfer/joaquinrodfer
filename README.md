...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0F2027,50:203A43,100:2C5364&height=200&section=header&text=Joaqu%C3%ADn%20Rodr%C3%ADguez%20Ferrer&fontSize=42&fontColor=ffffff&animation=fadeIn&desc=Data%20Science%20%26%20AI%20%7C%20Python%20%C2%B7%20SQL%20%C2%B7%20Power%20BI%20%C2%B7%20ETL&descSize=18&descAlignY=58" width="100%"/>
...
**Computer Engineer** at the **Universidad de Jaén**, about to start a **Master's in Data Science & AI at Evolve** this October. I turn messy, complex data into practical solutions through analysis, automation and software engineering.

I've worked as an **AI & Automation Researcher**, running and evaluating Computer Vision / Deep Learning models (YOLO and others) over datasets of millions of satellite images, building pipelines to automate repetitive workflows and documenting the research along the way. I also connect relational databases with BI tools (Power BI, KNIME) to turn raw tables into dashboards people actually use for decisions.

Outside of "official" work, I like owning my own infrastructure — I run a **Homelab on Proxmox** — and I build side projects end-to-end, from the database up to the UI.

```text
const joaquin = {
    role: "Final-year Computer Engineering student · Data Science & AI",
    location: "Jaén, España 🇪🇸",
    currentlyLearning: ["NLP", "Big Data", "Scalable ML architectures"],
    startingSoon: "Master in Data Science & AI @ Evolve — Oct 2026",
    funFact: "Runs a Proxmox homelab for fun, not for work"
};
```
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://streak-stats.demolab.com?user=joaquinrodfer&theme=tokyonight&hide_border=true"/>
  <img src="https://streak-stats.demolab.com?user=joaquinrodfer&theme=default&hide_border=true"/>
</picture>
...
<a href="https://joaquinrodfer.es"><img src="https://img.shields.io/badge/Website-joaquinrodfer.es-2C5364?style=for-the-badge&logo=googlechrome&logoColor=white" /></a>
